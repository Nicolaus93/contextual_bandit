...
def artificial_data_generator(T=1000, d=10, K=10, classes=5, numUsers=1, model=None):
...
if __name__ == '__main__':
    X, Y, users, model = artificial_data_generator(T=2, d=5, K=3, classes=2, numUsers=1, model=model)
